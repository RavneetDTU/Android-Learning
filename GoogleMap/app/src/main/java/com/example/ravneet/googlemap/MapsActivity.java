package com.example.ravneet.googlemap;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng delhi = new LatLng(28.6969241,77.0723422);
        ...
        mMap.addCircle(new CircleOptions().center(delhi).radius(10).fillColor(Color.argb(50,50,50,150)));

        mMap.addPolygon(new PolygonOptions()
                .add(new LatLng(28,77))
                .add(new LatLng(28,78))
                .add(new LatLng(29,78))
