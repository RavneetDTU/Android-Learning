package com.example.ravneet.hardwaresensor;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView tvAx = (TextView) findViewById(R.id.tv_ax);
        final TextView tvAy = (TextView) findViewById(R.id.tv_ay);
        final TextView tvAz = (TextView) findViewById(R.id.tv_az);
